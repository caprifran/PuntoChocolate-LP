    ...
    <section className="py-24 bg-cream overflow-hidden">
      <div className="container mx-auto px-12">
        <div className="flex flex-col md:flex-row gap-12 items-end mb-24" id="alfajores">
          <AnimatedReveal className="md:w-1/2 aspect-[4/5] bg-choco relative" direction="left">
            <Image
          ...
          <AnimatedReveal className="md:w-1/2 pb-12" direction="right" delay={0.2}>
            <span className="text-choco font-label text-sm uppercase tracking-[0.3em] mb-4 block">El Ícono Nacional</span>
