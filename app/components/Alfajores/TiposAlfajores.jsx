...
export default function TiposAlfajores() {
  const [activeTab, setActiveTab] = useState(0);
  return (
    <section className="my-16 bg-cream pb-[10px]" id="tipos-alfajores">
      <div className="mx-auto">
        {/* Tabs */}
        <div className="flex flex-nowrap gap-8 border-b border-choco/10 mb-12 overflow-x-auto no-scrollbar">
          {alfajores.map((grupo, idx) => (
            <button
              key={grupo.type}
        ...
        <EmblaCarousel resetKey={activeTab}>
          {alfajores[activeTab].sabores.map((sabor, i) => (
